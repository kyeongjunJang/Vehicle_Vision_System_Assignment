function [m1, m2] = get_correspondence_points(img1, img2, disp)
...
if (disp == 1)
    drawnow; figure, imagesc(keypoint_img1), title('Image1 Feature points'),axis image, colormap(gray), hold on
...
%     plot(XY_img1(inlier_idx,1),XY_img1(inlier_idx,2),'gs'),
    ...
    drawnow; figure, imagesc(keypoint_img2),title('Image2 Feature points'), axis image, colormap(gray), hold on
